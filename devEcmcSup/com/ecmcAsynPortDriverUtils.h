...
// First data type is always ECMC and second EPICS so for writes (i.e. AO-records) the conversion is done "backwards"
#define ECMC_OPTION_CMD_UINT64_TO_FLOAT64 "UINT64TOFLOAT64"
#define ECMC_OPTION_CMD_UINT32_TO_FLOAT64 "UINT32TOFLOAT64"
#define ECMC_OPTION_CMD_INT64_TO_FLOAT64  "INT64TOFLOAT64"
#define ECMC_OPTION_CMD_FLOAT64_TO_INT32  "FLOAT64TOINT32"
