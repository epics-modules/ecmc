...
enum ecmcRtLoggerPortLevel {
  ...
  ECMC_RT_LOGGER_PORT_LEVEL_ERROR = 1
};
...
void ecmcRtLoggerPortDriverPublishMessage(int level, const char *message) {
  ...
  portDriver_->publishMessage(level, message);
}
