...
#define MAX_NUM_DYNAMIC_CREATED_PARAMS 1000
...
public:
    //ecmcAsynPortDriver(const char *portName, int maxArraySize);
...
private:
    ...
    //const char *dynParameterList[MAX_NUM_DYNAMIC_CREATED_PARAMS];
};
