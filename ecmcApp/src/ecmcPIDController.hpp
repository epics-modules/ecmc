...
{
public:
  ecmcPIDController(ecmcAxisData *axisData,double sampleTime);
  ecmcPIDController(ecmcAxisData *axisData,double kp, double ki, double kd, double kff, double sampleTime, double outMax, double outMin);
  ~ecmcPIDController();
  void initVars();
  void reset();
