...
EthercatMCConfigController "MCU1", "Cfg.EcAddSdo(11,0x608F,0x1,51200,4)"
EthercatMCConfigController "MCU1", "Cfg.EcAddSdo(11,0x608F,0x2,1,4)"

#Motor Pole pair count (50)
EthercatMCConfigController "MCU1", "Cfg.EcAddSdo(11,0x2030,0x0,50,4)"

#Maximal current (3000mA)
EthercatMCConfigController "MCU1", "Cfg.EcAddSdo(11,0x2031,0x0,3000,4)"

#Over voltage limit (51000mV)
EthercatMCConfigController "MCU1", "Cfg.EcAddSdo(11,0x2034,0x0,51000,4)"

#Under voltage limit (45000mV)
EthercatMCConfigController "MCU1", "Cfg.EcAddSdo(11,0x2035,0x0,45000,4)"

#Open loop current reduction at standstill (reduce by 70%=>-70)
EthercatMCConfigController "MCU1", "Cfg.EcAddSdo(11,0x2037,0x0,-70,4)"

#Open loop current reduction at standstill idele time (100ms at stanstill then reduction)
EthercatMCConfigController "MCU1", "Cfg.EcAddSdo(11,0x2036,0x0,100,4)"
...
EthercatMCConfigController "MCU1", "Main.M1.fVelocity=100"
...
EthercatMCConfigController "MCU1", "Cfg.LinkEcEntryToAxisEncoder(11,POSITION,1,0,-1)"
EthercatMCConfigController "MCU1", "Cfg.SetAxisEncScaleDenom(1,51200)"
EthercatMCConfigController "MCU1", "Cfg.SetAxisEncScaleNum(1,360)"
EthercatMCConfigController "MCU1", "Cfg.SetAxisEncType(1,0)"
EthercatMCConfigController "MCU1", "Cfg.SetAxisEncBits(1,32)"
EthercatMCConfigController "MCU1", "Cfg.LinkEcEntryToAxisDrive(11,STM_CONTROL,1,0,-1)"
EthercatMCConfigController "MCU1", "Cfg.LinkEcEntryToAxisDrive(11,VELOCITY_SETPOINT,1,1,-1)"
EthercatMCConfigController "MCU1", "Cfg.LinkEcEntryToAxisDrive(11,STM_STATUS,1,2,-1)"
EthercatMCConfigController "MCU1", "Cfg.SetAxisDrvScaleDenom(1,1.0)"
EthercatMCConfigController "MCU1", "Cfg.SetAxisDrvScaleNum(1,1.0)"
...
EthercatMCConfigController "MCU1", "Cfg.SetAxisMonMaxVel(1,8000)"
...
EthercatMCConfigController "MCU1", "Cfg.SetAxisMonCntrlOutHL(1,7500)"
