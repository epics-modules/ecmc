...
#Test Resolver input
ecmcConfigController "MCU1", "Cfg.EcAddEntryComplete(17,0x2,0x1c213052,1,2,0x1600,0x7010,0x01,16,CONTROL)"
ecmcConfigController "MCU1", "Cfg.EcAddEntryComplete(17,0x2,0x1c213052,1,2,0x1601,0x7010,0x06,32,VELOCITY_SETPOINT)"
ecmcConfigController "MCU1", "Cfg.EcAddEntryComplete(17,0x2,0x1c213052,2,3,0x1a00,0x6000,0x11,32,POSITION)"
ecmcConfigController "MCU1", "Cfg.EcAddEntryComplete(17,0x2,0x1c213052,2,3,0x1a01,0x6010,0x01,16,STATUS)"
#NOTE important the sync 1 period needs to be 0!
ecmcConfigController "MCU1", "Cfg.EcSlaveConfigDC(17,0x700,1000000,500000,0,0)"
ecmcConfigController "MCU1", "Cfg.EcAddSdo(17,0x8011,0x11,1000,4)"
ecmcConfigController "MCU1", "Cfg.EcSlaveConfigWatchDog(17,1000,10000)"

#*************** Distributed clocks config EL7201
#Sync mode 
ecmcConfigController "MCU1", "Cfg.EcAddSdo(17,0x1C32,0x1,3,2)"
#Cycle time
ecmcConfigController "MCU1", "Cfg.EcAddSdo(17,0x1C32,0x2,1000000,4)"
#Sync mode 
ecmcConfigController "MCU1", "Cfg.EcAddSdo(17,0x1C33,0x1,3,2)"
#Cycle time
ecmcConfigController "MCU1", "Cfg.EcAddSdo(17,0x1C33,0x2,1000000,4)"
...
#Nominal voltage = 48V
ecmcConfigController "MCU1", "Cfg.EcAddSdo(17,0x8010,0x19,48000,4)"

#Motor max current = 6A
ecmcConfigController "MCU1", "Cfg.EcAddSdo(17,0x8011,0x11,6000,4)"

#Motor rated current = 4A
ecmcConfigController "MCU1", "Cfg.EcAddSdo(17,0x8011,0x12,4000,4)"

#Motor pole pairs = 3
ecmcConfigController "MCU1", "Cfg.EcAddSdo(17,0x8011,0x13,3,1)"
...
ecmcConfigController "MCU1", "Cfg.LinkEcEntryToAxisEncoder(17,POSITION,1,0,-1)"
...
ecmcConfigController "MCU1", "Cfg.LinkEcEntryToAxisDrive(17,CONTROL,1,0,-1)"
ecmcConfigController "MCU1", "Cfg.LinkEcEntryToAxisDrive(17,VELOCITY_SETPOINT,1,1,-1)"
ecmcConfigController "MCU1", "Cfg.LinkEcEntryToAxisDrive(17,STATUS,1,2,-1)"
# 32 bits (+-31 bits)
...
#ecmcConfigController "MCU1", "Cfg.WriteEcEntryIDString(17,CONTROL,7)"
